...
class NormalBtreeDiskIndex : public OneDimIndex<Key, Value> {
 public:
  NormalBtreeDiskIndex(std::string params, int read_latency, int write_latency) 
  : btree(params.c_str(), btree::InsertStrategy::Normal, read_latency, write_latency) {}
...
class FsplitNBtreeDiskIndex : public OneDimIndex<Key, Value> {
 public:
  FsplitNBtreeDiskIndex(std::string params, int read_latency, int write_latency) 
  : btree(params.c_str(), btree::InsertStrategy::FsplitN, read_latency, write_latency) {}
...
class BLinktreeDiskIndex : public OneDimIndex<Key, Value> {
 public:
  BLinktreeDiskIndex() : btree("testblink.db") {}
...
class CCBtreeDiskIndex : public OneDimIndex<Key, Value> {
 public:
  CCBtreeDiskIndex(std::string params, int read_latency, int write_latency) 
  : btree(params.c_str(), read_latency, write_latency) {}
