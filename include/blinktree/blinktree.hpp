#ifndef TREE_H__
#define TREE_H__
#include "blinktree/blinktree_node.hpp"
...
restart:
	...
	void footprint(uint64_t& meta, uint64_t& structural_data_occupied,
                 uint64_t& structural_data_unoccupied, uint64_t& key_data_occupied,
                 uint64_t& key_data_unoccupied){
    auto cur = root;
