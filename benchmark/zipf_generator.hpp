//
//  Adopted from https://github.com/basicthinker/YCSB-C/blob/master/core/zipfian_generator.h
//

#ifndef ZIPFIAN_GENERATOR_H_
#define ZIPFIAN_GENERATOR_H_
